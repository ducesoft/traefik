...
type Dialer interface {
	...
	DialContext(ctx context.Context, network, addr string, clientConn next.ClientConn) (c net.Conn, err error)
...
func (d tcpDialer) DialContext(ctx context.Context, network, addr string, clientConn next.ClientConn) (net.Conn, error) {
...
func (d tcpTLSDialer) DialContext(ctx context.Context, network, addr string, clientConn next.ClientConn) (net.Conn, error) {
...
func (that *tlsDialer) Dial(network, addr string, clientConn next.ClientConn) (net.Conn, error) {
	return that.DialContext(context.Background(), network, addr, clientConn)
}

func (that *tlsDialer) DialContext(ctx context.Context, network, addr string, clientConn next.ClientConn) (c net.Conn, err error) {
	return that.d.DialContext(next.NewProxyProtoContext(ctx, clientConn), network, addr)
}
